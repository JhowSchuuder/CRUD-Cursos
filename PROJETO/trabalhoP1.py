...
def imprimir_aluno(a):
  print(a.nome + " | " + a.cpf + " | " + str(a.dtNasc) + " | " + a.sexo + " | " + a.email + " | " + a.telefone)
...
def imprimir_curso(c):
  print(c.codigo + " | " + c.descricao + " | " + str(c.cargaHoraria) + " | " + str(c.preco))
...
def imprimir_matricula(m):
    print(m.cpfAluno + " | " + m.codigoCurso + " | " + str(m.dataInicio) + " | " + str(m.dataFim) + " | " + str(m.desconto))
...
#inicio do programa
if existe_arquivo("Trabalho/Alunos.txt") == False:
    arq = open("Trabalho/Alunos.txt",'w')
    print("Arquivo de alunos criado e pronto para a escrita")
    
if existe_arquivo("Trabalho/Cursos.txt") == False:
    arq = open("Trabalho/Cursos.txt",'w')
    print("Arquivo de cursos criado e pronto para a escrita")

if existe_arquivo("Trabalho/Matriculas.txt") == False:
    arq = open("Trabalho/Matriculas.txt",'w')
